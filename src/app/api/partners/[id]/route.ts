...
export async function PUT(request: Request, context: { params: Params }) {
  ...
  try {
    ...
    // completed_orders and cancelled_orders are typically managed by other processes (order status changes)
    // and not directly editable via this general partner update endpoint.
