...
// Log the environment variables as seen by the server process
...
if (!supabaseUrl) {
  console.error("CRITICAL ERROR: Missing env.NEXT_PUBLIC_SUPABASE_URL. Ensure .env file is correct and server is restarted.");
  throw new Error("Missing env.NEXT_PUBLIC_SUPABASE_URL");
}
if (!supabaseAnonKey) {
  console.error("CRITICAL ERROR: Missing env.NEXT_PUBLIC_SUPABASE_ANON_KEY. Ensure .env file is correct and server is restarted.");
